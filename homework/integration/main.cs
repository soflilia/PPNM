...
class MainINT{
    public static void Main(){
        ...
        double result1 = Int.integrate(f1,0,1)[0];
        ...
        double result2 = Int.integrate(f2,0,1)[0];
        ...
        double result3 = Int.integrate(f3,0,1)[0];
        ...
        double result4 = Int.integrate(f4,0,1)[0];
    ...
    public static double erf(double z){
        ...
        if(a <=z && z<=b){
            ...
            return 2.0/Math.Sqrt(Math.PI)*Int.integrate(f,0,z)[0];
            }
        else{
            Func <double, double> f1 = x=> Math.Exp(-(Math.Pow(z+(1-x)/x,2))/x/x);
            return 1-2.0/Math.Sqrt(Math.PI)*Int.integrate(f1,0,1)[0];
            }
        }
} // EVD STOPS
